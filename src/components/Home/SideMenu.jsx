  ...
  return (
    <div className="h-[100vh] w-64 px-4 py-6   flex flex-col justify-between transition-all duration-300">
      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={toggleTheme} className="p-2 rounded-full bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-400 dark:hover:bg-gray-600 transition-all">
          {theme === "light" ? "🌙" : "☀️"}
        </button>
      </div>
    </div>
